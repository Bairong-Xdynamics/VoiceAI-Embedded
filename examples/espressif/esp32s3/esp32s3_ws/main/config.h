...
// Twilio / realtime WebSocket URL
inline const std::string kTwilioWebSocketUrl = "wss://baiyu-pre.100credit.cn/api/realtime/calls/v1/dialog";
...
// Twilio / realtime WebSocket URL
inline const std::string kTwilioWebSocketUrl = "wss://baiyu.resultscloud.com/api/realtime/calls/v1/dialog";
// MQTT broker endpoint (host:port)
