...
void WifiConfigurationAp::StartAccessPoint()
{
    ...
    // In APSTA mode, we also need a STA netif for the STA interface.
    // Without it, the WiFi driver holds a stale/invalid netif reference
    // for the STA interface, causing crashes when STA connects.
