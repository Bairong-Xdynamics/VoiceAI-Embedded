...
public:
    ...
    static constexpr int kPcmSendSampleRate = 16000;
    static constexpr int kPcmSendFrameMs = 20;
    static constexpr size_t kPcmSendFrameBytes = static_cast<size_t>(kPcmSendSampleRate / 1000 * kPcmSendFrameMs) * sizeof(int16_t);
    static constexpr size_t kUplinkPcmBufferMaxBytes = kPcmSendFrameBytes * 50;
